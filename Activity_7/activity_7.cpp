...
class UG:public course{ //derived class UG
    private: //declaration of private data
        string stream,ug_teacher;
        int ug_c_duration;
    public:
        void input(){ // member function for input of data
            cout<<"\nEnter course name: ";
            cin>>c_name;
        ...
        void display(){ //member function for display of data
...
class PG:public course{ // drived class PG
    private:// declaration of private data
...
class Diploma:public course{ //derived class Diploma
